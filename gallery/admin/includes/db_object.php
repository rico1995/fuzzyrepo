...
class Db_object{
    ...
    #methods
    #101.lesson worked fine, but not for the instructor. why? was not needed to replace static:: with static:: why?
    ...
    #worked without changing "new self" to get_called_class. why? {was duplicate method in user.php}
